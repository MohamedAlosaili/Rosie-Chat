...
function Profile() {
    ...
    return (
        <>
            ...
            <section className="">
                <h1 className="dark:text-primary-200 text-2xl font-semibold">Profile</h1>
                    ...
                    {showDeletePrompt && (
                        <Modal closeModal={() => !deletingUser ? setShowDeletePrompt(false) : null}>
                            <div className="p-6 rounded-xl min-w-[20rem] text-center dark:bg-primary-800">
                                <BsFillExclamationCircleFill size="50" className="block mx-auto mb-2" color="rgb(153, 27, 27)" />
